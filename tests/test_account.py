...
class TestAccount:
    ...
    def test_account_page_open_authorized(self, driver_account):
        account_page = AccountPage(driver_account)
        account_page.wait_element(BasePageLocators.account_button)
        account_page.click_element_and_waiting_element_download(BasePageLocators.account_button,
    ...
    def test_account_open_order_history(self, driver_account):
        account_page = AccountPage(driver_account)
    ...
    def test_account_logout(self, driver_account):
        account_page = AccountPage(driver_account)
